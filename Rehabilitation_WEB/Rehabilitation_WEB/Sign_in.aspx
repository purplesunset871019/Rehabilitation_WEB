...
<body>
    <form  class="login" runat="server">
        ...
        <p></p>
        <asp:TextBox ID="accounttxt" runat="server" placeholder="請輸入員工編號" font-size="20px" padding="5px" border-radius="4px" margin="0px auto" display="block" width="80%"></asp:TextBox>
        <p></p>
        <asp:Label ID="Label3" runat="server" Text="密碼" font-size="30px"></asp:Label>
         <p></p>
        <asp:TextBox ID="passwordtxt" runat="server" placeholder="請輸入密碼" font-size="20px" padding="5px" border-radius="4px" margin="0px auto" display="block" width="80%"></asp:TextBox>        
        <p></p>
